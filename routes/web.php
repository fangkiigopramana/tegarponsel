...
|
*/
// Routes customer previledge


Route::controller(UserController::class)->group(function () {
    
    Route::get('/register', 'register')->name('customer.register');
    Route::post('/register', 'registerStore')->name('customer.register.store');
    Route::get('/', 'index')->name('customer.home');
    Route::get('/product-detail/{product:id}', 'productDetail')->name('customer.product-detail');
    Route::get('/my-cart','viewCart')->name('customer.cart.view')->middleware('checkrole:customer');;
    Route::post('/add-to-cart','addToCart')->name('customer.cart.add')->middleware('checkrole:customer');;
    Route::get('/buy-product/{data:id}','buyProductCart')->name('customer.cart.buy')->middleware('checkrole:customer');    
    Route::get('/confirm-product/{data:id}','confirmPaidCart')->name('customer.cart.confirm')->middleware('checkrole:admin');    
});
...
Route::middleware(['auth', 'checkrole:admin'])->group(function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        Route::get('/logout', 'destroy')->name('admin.logout')->middleware(['checkrole:customer,admin']);
