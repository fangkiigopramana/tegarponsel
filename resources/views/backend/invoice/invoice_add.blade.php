...
<!--  ---------------------------------- -->
        ...
        <form method="post" action="{{ route('invoice.store') }}">
            ...
            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="discount_amount" value="0" id="discount_amount" class="form-control estimated_amount"
            ...
            <div class="row new_customer" style="display: none">
                ...
                <div class="form-group col-md-4">
                    <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Customer Mobile Number">
                </div>
