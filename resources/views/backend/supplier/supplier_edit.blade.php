            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('supplier.update') }}" enctype="multipart/form-data" id="myForm">
                            @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-10">
                                <input class="form-control" name="name" type="text" value="{{ $supplier->name }}">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-10">
                                <input class="form-control" name="mobile_no" type="text" value="{{ $supplier->mobile_no }}">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
