                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    ...
                                    <input class="form-control example-date-input" type="text" name="purchase_no" id="purchase_no" value="">
                                </div>
                            </div>
...
<script id="document-template" text="text/x-handlebars-template">
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
        <input type="number" min="1" class="form-control buying_qty" name="buying_qty[]" value="">
    </td>
...
<script text="text/javascript">
    $(document).ready(function() {
        $(document).on("click", ".addeventmore", function(){
            ...
            var category_name = $('#supplier_id').find('option:selected').text();
